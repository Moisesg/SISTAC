...
<html lang="es">
   <head>
      ...
      <title>SIGES | @yield('page_heading')</title>
      ...
      {!!Html::style('dist/css/sbadmin.css') !!}
      {!!Html::style('vendors/font-awesome/css/font-awesome.min.css') !!}    
      {!!Html::style('vendors/pnotify/pnotify.custom.min.css') !!}   
      <style type="text/css">
         td.highlight { font-weight: bold; color: #2A3F54; text-decoration: underline; }
         .table-hover tbody tr:hover td, .table-hover tbody tr:hover th { background-color: #8edecf; }
         .textRow-warning{color:#da8000;}
      </style>
   </head>
   <body>
      <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
               <div class="sidebar-nav navbar-collapse">
                  <ul class="nav" id="side-menu">
                     ...
                     <li>
                        <a href="{!! route('dashboard.index') !!}"><i class="fa fa-home fa-fw"></i> Principal</a>
                     </li>
                     <li>
