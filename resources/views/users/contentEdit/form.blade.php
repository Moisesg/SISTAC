      ...
      <div class="panel panel-default" style="background-color: transparent;">
         ...
         <div class="panel-body" >
            <div class="alert alert-info" role="alert" style="margin-top:10px;">
               ...
               Ingrese la información solicitada en el formulario, al finalizar de clic en el boton <b>Actualizar Usuario </b>
            </div>
               ...
               <div class="form-group">
                  <div class="col-lg-6">
                     ...
                     <div class="col-lg-8">
                        ...
                        "CAPTURISTA POR DIRECCION"=>"CAPTURISTA POR DIRECCION",
                        "CONSULTOR POR DIRECCION"=>"CONSULTOR POR DIRECCION"], 
                        null, array('id'=>'tipo','class' => 'form-control', "size"=>"6","required"=>"required" )) !!}
                     </div>
                  </div>
                  <div class="col-lg-6">
                     {!!Form::label("direccion","Direccion",["class"=>"col-sm-4 control-label"] )!!}                                                   
                     <div class="col-lg-8">
                        @if($user->direccion != "TODAS" )
                        {!! Form::select('direccion', [ 
                        "DIRECCION DE ADMINISTRACION"=>"DIRECCION DE ADMINISTRACION",
                        "DIRECCION GENERAL"=>"DIRECCION GENERAL",
                        "DIRECCION JURIDICA"=>"DIRECCION JURIDICA",
                        "DIRECCION DE SEGURIDAD"=>"DIRECCION DE SEGURIDAD",
                        "DIRECCION TECNICA"=>"DIRECCION TECNICA"], 
                        null, array('id'=>'direccion','class' => 'form-control', "size"=>"6","required"=>"required" ))  !!}
                        @else
                        {!! Form::select('direccion',[], null, array('id'=>'direccion','class' => 'form-control', "size"=>"6","required"=>"required","readonly"=>true ))  !!}
                        @endif 
                     </div>
                  </div>
               </div>
